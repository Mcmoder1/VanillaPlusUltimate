package net.moder0.vanillaplus.command;
...
import net.moder0.vanillaplus.util.IEntityDataSaver;
...
public class TpHomeCommand {
    public static void register(CommandDispatcher<ServerCommandSource> serverCommandSourceCommandDispatcher,
        ...
        serverCommandSourceCommandDispatcher.register(CommandManager.literal("home")
                .then(CommandManager.literal("tp").executes(TpHomeCommand::run)));
    }
    ...
    private static int run(CommandContext<ServerCommandSource> context) throws CommandSyntaxException {
        ...
        if(homepos.length != 0) {
            ...
            context.getSource().sendFeedback(() -> Text.literal("successfully teleported player"), false);
            return 1;
        } else {
