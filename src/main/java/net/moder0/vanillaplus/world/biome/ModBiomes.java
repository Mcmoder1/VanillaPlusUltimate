...
public class ModBiomes {
    ...
    public static final RegistryKey<Biome> DEEP_DARK_FOREST = RegistryKey.of(RegistryKeys.BIOME, new Identifier(VanillaPlus.MOD_ID, "deep_dark_forest"));

    public static void boostrap(Registerable<Biome> context){
        context.register(DEEP_DARK_WASTELAND, deep_dark(context));
        context.register(DEEP_DARK_FOREST, deep_dark(context));
    }
    ...
    public static Biome deep_dark_forest(Registerable<Biome> context) {
        SpawnSettings.Builder spawnBuilder = new SpawnSettings.Builder();
